...
import { MealsRules } from '../utils/rules'
...
export async function mealsRoutes(app: FastifyInstance) {
  app.get(
    '/',
    {
      preHandler: [
        ensureAuthenticaded,
        checkPermissions([MealsRules.MEALS_READ_OTHERS]),
      ],
    },
    async (req, res) => {
      try {
  ...
  app.post(
    '/',
    {
      preHandler: [
        ensureAuthenticaded,
        checkPermissions([MealsRules.MEALS_CREATE]),
      ],
    },
    async (req, res) => {
      try {
  ...
  app.put(
    '/:id',
    {
      preHandler: [
        ensureAuthenticaded,
        checkPermissions([MealsRules.MEALS_UPDATE]),
      ],
    },
    async (req, res) => {
      try {
  ...
  app.delete(
    '/:id',
    {
      preHandler: [
        ensureAuthenticaded,
        checkPermissions([MealsRules.MEALS_DELETE]),
      ],
    },
    async (req, res) => {
      try {
