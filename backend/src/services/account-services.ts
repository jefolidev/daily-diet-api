...
export async function getAllTheAccounts(): Promise<UserAccount[]> {
  try {
    ...
    console.error(
      'An error occurred while trying to get the accounts. See the error below: ',
      error,
    )
...
export async function getFirstMatchedEmail(email: string) {
  try {
    ...
    throw new Error(
      'An error occurred while trying to get the emails. ' + error,
    )
  }
}
...
export async function getRoleFromUser(accountId: string) {
  try {
    ...
    console.error(
      'An error occurred while trying to get the role of current user. See the error below: ',
      error,
    )
    throw new Error(
...
export async function createNewAccount(accountData: UserAccount) {
  try {
    ...
    console.error(
      'An error occurred while trying to create the account. See the error below: ',
      error,
    )
