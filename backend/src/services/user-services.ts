import {
  ...
  insertUserIntoDB,
  selectAllUsers,
  selectMealsFromUserById,
} from '../database/queries/users-queries'
...
export async function getAllTheUsers() {
  try {
    ...
    console.error(
      'An error occurred while trying to get the users. See the error below: ',
      error,
    )
...
export async function getMealsFromUserById(accountId: string) {
  try {
    ...
    console.error(
      'An error occurred while trying to get the meals from the current user. See the error below: ',
      error,
    )
    throw new Error(
      'An error occurred while trying to get the meals from the current user. ',
    )
  }
}
...
export async function createNewUser(userData: UserType, accountId: string) {
  try {
    ...
    console.error(
      'An error occurred while trying to create a user. See the error below: ',
      error,
    )
...
export async function removeUserById(userId: string) {
  try {
    ...
    console.error(
      'An error occurred while trying to remove a user. See the error below: ',
      error,
    )
