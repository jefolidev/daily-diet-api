...
type EditedMeal = z.infer<typeof editMealSchema>

export function EditMealItem() {
  const { handleSubmit, register } = useForm<EditedMeal>({
    resolver: zodResolver(editMealSchema)
  })

  function handleSubmitNewMeal(data: EditedMeal) {
    console.log(data)
  }
